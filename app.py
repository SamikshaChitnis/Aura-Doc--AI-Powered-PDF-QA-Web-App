...
st.set_page_config(page_title="AuraDoc", layout="centered")
...
# ── Auth page ─────────────────────────────────────────────────────────────────
def auth_page():
    st.markdown('<p class="auth-title">AuraDoc</p>', unsafe_allow_html=True)
...
def chat_page():
    ...
    with st.sidebar:
        st.markdown(f'<p class="sidebar-brand">AuraDoc</p>', unsafe_allow_html=True)
